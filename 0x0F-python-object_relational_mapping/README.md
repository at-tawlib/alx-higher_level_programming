...
## [100-relationship_states_cities.py](100-relationship_states_cities.py), [relationship_city.py](relationship_city.py), [relationship_state.py](relationship_state.py), [100-relationship_states_cities.sql](100-relationship_states_cities.sql)
...
guillaume@ubuntu:~/0x0F$ 
```
## [101-relationship_states_cities_list.py](101-relationship_states_cities_list.py), [101-relationship_states_cities_list.sql](101-relationship_states_cities_list.sql)
a script that lists all  `State`  objects, and corresponding  `City`  objects, contained in the database  `hbtn_0e_101_usa`
-   script should take 3 arguments:  `mysql username`,  `mysql password`  and  `database name`
-   The connection to MySQL server must be to  `localhost`  on port  `3306`
-   must use the  `cities`  relationship for all  `State`  objects
